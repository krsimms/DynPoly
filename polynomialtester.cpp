...
// Postcondition: The user has been prompted for a coefficent and degree of the term added.  

void test_assign(polynomial& test);
// Postcondition: The user has been prompted for the degree and the coeffinient to be set. 

void test_clear(polynomial& test);
// Postcondition: test.clear( ) has been activated.

void test_eval(const polynomial& test);
// Post conditon:  The user has been prompted for the x value.  T

void test_np(const polynomial& test);
// Post conditon:  The user has been prompted for the e value. 
...
void view(const polynomial& test)
{
	cout << view << " (degree is " << test.degree( ) << ")" << endl;
}
